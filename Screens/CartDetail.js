...
import { CART_DETAIL } from "../Constants/Component.testids";
...
const CartDetail = ({ navigation }) => {
    ...
    return (
        <FlatList
            ...
            ListEmptyComponent={<View style={{marginTop: 20, justifyContent: 'center', alignItems:'center'}}><TouchableOpacity testID={CART_DETAIL.EMPTY_CART_BUTTON} onPress={() => navigation.goBack()}><Text style={{ fontSize: 20, textDecorationLine:'underline'}}>Let's Shop!</Text></TouchableOpacity></View>}
